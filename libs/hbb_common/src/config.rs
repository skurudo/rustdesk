...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("desk.rsadm.ru".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RemoteSysAdmin".to_owned());
...
pub const RS_PUB_KEY: &str = "cqZVEmA5ifcQAVkmKXMUsjJYATlwFHMscGldgOD+9+E=";
